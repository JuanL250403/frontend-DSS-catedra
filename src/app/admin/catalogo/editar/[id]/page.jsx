...
export default function CrearProducto() {
    ...
    const cargarProducto = async () => {
        ...
        await peticiones.get(`videojuegos/${id}`).then((r) => {
            const juego = r.data.data

            setNombre(juego.nombre)
            setDescripcion(juego.descripcion)
            setPrecio(juego.precioUnitario)
            setCantidad(juego.cantidad)
            setCategoria(juego.categoria.id)
            setCalificacion(juego.calificacion)
            setRequisitos(juego.requisitosSistema)
        })
        setCargando(false)
    }
    ...
    const editarProducto = async () => {
        ...
        await peticiones.put(`videojuegos/${id}`, data).then(() => showToast.success('Producto actualizado'))
    }
